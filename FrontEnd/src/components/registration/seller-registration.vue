...
#app #login2 #form2 label, #app #login2 #form2 input {
  outline: none;
  width: 100%;
  color: #000;
}
...
#app #login2 #form2 form::placeholder, #app #login2 #form2 select {
  color: black;
  opacity: 1;
}

#app #login2 #form2 button,#app2 #form button{
...
#app #login2 #form2 button:hover,#app2 #form button:hover {
  color: #ecf0f1;
